...
export default function BadgePage() {
  return (
    <Flex direction='column'>
      <Text tag='h1' fontType='expressive-headline'>Badge</Text>
      <Flex direction='column' gap='medium'>
        <Text fontType='expressive-headline' size='5x-large' tag='h2'>Type</Text>
      ...
      <Flex direction='column' gap='medium'>
        <Text fontType='expressive-headline' size='5x-large' tag='h2'>Size</Text>
      ...
      <Flex direction='column' gap='medium'>
        <Text fontType='expressive-headline' size='5x-large' tag='h2'>Style</Text>
