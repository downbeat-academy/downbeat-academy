...
export default function LogoPage() {
  return (
    <Flex direction='column' gap='medium'>
      <Text tag='h1' fontType='expressive-headline' size='6x-large'>Logo</Text>
      <Flex direction='column' gap='large'>
        <Text tag='h2' fontType='expressive-headline' size='5x-large'>Types</Text>
        <LogoSymbol width={300} />
        <LogoText width={300} />
        <LogoLockup width={300} />
      </Flex>
      <Flex direction='column' gap='large'>
        <Text tag='h2' fontType='expressive-headline' size='5x-large'>Colors</Text>
