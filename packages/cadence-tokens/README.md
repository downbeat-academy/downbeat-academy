...
[style-dictionary](https://styledictionary.com). Every colour, space, radius, and type
...
## Colour is two-layered

`tokens/color/palette.json` holds raw ramps. The other colour files are the semantic
