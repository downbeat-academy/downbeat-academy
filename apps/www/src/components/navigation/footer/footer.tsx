  ...
  return (
    <footer className={classes}>
        ...
        {footerLinks.map(title => {
          return (
            <article className={s[`link-column`]} key={title.name}>
              <Text type='productive-body' size='body-base' color='high-contrast' tag='p'>{title.title}</Text>
              <ul>
      ...
      <Flex direction='row' justifyContent='space-between' wrap>
        <Text type='productive-body' size='body-small' color='high-contrast' tag='p'>Copyright &copy; 2023 Downbeat Academy</Text>
        <aside className={s[`copyright-links`]}>
          <Flex direction='row' gap='large' wrap>
            <Text tag='p' type='productive-body' size='body-small'><Link href='/terms-and-conditions' className={s[`high-contrast-link`]}>Terms & Conditions</Link></Text>
            <Text tag='p' type='productive-body' size='body-small'><Link href='/privacy-policy' className={s[`high-contrast-link`]}>Privacy Policy</Link></Text>
          </Flex>
        </aside>
      </Flex>
    </footer>
