...
async function getHandbooks() {
	const res = sanityClient.fetch(handbookPageQuery, {
		revalidate: 60,
	})
				...
				<SectionTitle
					...
					subtitle={
						<Text
							...
							collapse
						>
							The Downbeat Academy Handbook is a collection of educational
							content that covers a wide range of topics. From music theory to
							instrument technique, the handbook is a valuable resource for
